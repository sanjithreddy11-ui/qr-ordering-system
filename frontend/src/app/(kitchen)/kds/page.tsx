    ...
    <div className="fixed inset-0 w-full h-full overflow-hidden bg-[#0E100D] flex text-[#E5E7E1]">
      <style>{`
        ...
        * { box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        /* Thin, modern scrollbar for each Kanban column's order list.
           Track stays transparent so the scrollbar is only visible while
           the column actually has overflow to scroll through. */
        .kds-col-scroll {
          scrollbar-width: thin;
          scrollbar-color: rgba(255,255,255,0.12) transparent;
        }
        .kds-col-scroll::-webkit-scrollbar { width: 5px; }
        .kds-col-scroll::-webkit-scrollbar-track { background: transparent; }
        .kds-col-scroll::-webkit-scrollbar-thumb {
          background: rgba(255,255,255,0.12);
          border-radius: 9999px;
        }
        .kds-col-scroll::-webkit-scrollbar-thumb:hover { background: rgba(255,255,255,0.22); }
      `}</style>
          ...
          <div className="grid grid-flow-col auto-cols-[85%] sm:auto-cols-[46%] lg:auto-cols-auto lg:grid-flow-row lg:grid-cols-4 gap-4 h-full overflow-x-auto lg:overflow-visible snap-x snap-mandatory lg:snap-none">
            {visibleColumns.map((col) => {
              ...
              return (
                <div
                  key={col.status}
                  className="snap-start flex flex-col min-w-0 min-h-0 h-full rounded-2xl border border-white/[0.06] bg-white/[0.02] overflow-hidden"
                >
                  <div
                    className="shrink-0 flex items-center gap-2 px-4 py-3 border-b bg-[#12140F]/80 backdrop-blur rounded-t-2xl"
                  ...
                  <div className="kds-col-scroll flex-1 min-h-0 overflow-y-auto px-3 py-3">
            ...
            {filterKey === "all" && (
              <div className="snap-start flex flex-col min-w-0 min-h-0 h-full rounded-2xl border border-white/[0.06] bg-white/[0.02] overflow-hidden">
                <div
                  className="shrink-0 flex items-center gap-2 px-4 py-3 border-b bg-[#12140F]/80 backdrop-blur rounded-t-2xl"
