  ...
  return (
    ...
    >
      ...
      <LegalSection heading="5. Payment Information">
        <p>
          Payments on the Platform are collected in cash at the counter. {legalConfig.productName}
          {" "}does not process online payments and does not collect or store card numbers, CVV,
          or UPI PINs.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="8. Third-Party Services">
        <p>
          ...
          cloud hosting providers for infrastructure. These providers process data only as
          necessary to provide their services and are bound by their own applicable privacy and
