  ...
  return (
    ...
    >
      ...
      <LegalSection heading="5. Payments">
        <p>
          Payments made through the Platform are collected in cash at the counter by the
          Merchant. {legalConfig.productName} does not process online payments and does not
          store your card, UPI, or banking credentials.
        </p>
        <p>
