...
export const STATUS_META: Record<TableStatus, { label: string; color: string }> = {
  ...
  // Settlements Module: bill has been submitted and is sitting in
  // Settlements awaiting the cashier to collect payment.
  awaiting_payment: { label: "Awaiting Payment", color: "#0EA5E9" },
