...
async function validateAndBuildOrder(body) {
  ...
  for (const requested of items) {
    ...
    const lineGst = gstService.computeLineGst(menuItem.price, quantity, menuItem.gstSlab, gstSettings);
    ...
    gstLineItems.push({ price: menuItem.price, quantity, gstSlab: menuItem.gstSlab });
  }
