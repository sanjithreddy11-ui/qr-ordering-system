...
// Performance: listReservations filters {restaurantId, reservationDate
// range} and sorts by {reservationDate, reservationTime} — matches this
// exactly, so the reservation list/calendar view doesn't scan+sort in
// memory.
