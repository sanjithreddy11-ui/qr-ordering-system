...
// Menu Item Customization (Modifiers): a small helper so every "Sauce"
// group below is built the exact same shape (required, single-choice)
// instead of hand-writing the group object at each of the 12 items it
// applies to. Slugifies each sauce name into a stable option id (e.g.
// "Red Sauce" -> "red-sauce"), matching the id style used for every other
// id in this file.
function sauceGroup(sauceNames) {
  return [
    {
      id: "sauce",
      name: "Sauce",
...
const rawMenu = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "chicken-with-herb-rice", name: "Chicken with Herb Rice", description: "Tender grilled chicken served over fragrant, herb-infused rice.", price: 479, diet: "non-veg", image: "/fooditems/lp2.png", modifierGroups: sauceGroup(["Mushroom Sauce", "Paprika Sauce"]) },
      { id: "fish-with-herb-rice", name: "Fish with Herb Rice", description: "Pan-seared fish fillet paired with aromatic herb-infused rice.", price: 489, diet: "non-veg", image: "/fooditems/lp3.png", modifierGroups: sauceGroup(["Mushroom Sauce", "Paprika Sauce"]) },
      { id: "paneer-with-herb-rice", name: "Paneer with Herb Rice", description: "Pan-seared paneer served over fragrant, herb-infused rice.", price: 449, diet: "veg", image: "/fooditems/ap1.png", modifierGroups: sauceGroup(["Mushroom Sauce", "Paprika Sauce"]) },
  ...
  },
  {
    ...
    title: "Pasta",
    items: [
      { id: "chicken-penne-in-spinach-alfredo-pasta", name: "Chicken Penne in Spinach Alfredo Pasta", description: "Penne and tender chicken tossed in a creamy spinach Alfredo sauce.", price: 419, diet: "non-veg", image: "/fooditems/ps1.png", modifierGroups: sauceGroup(["Red Sauce", "Mixed Sauce"]) },
      { id: "chicken-spaghetti-in-spinach-alfredo-pasta", name: "Chicken Spaghetti in Spinach Alfredo Pasta", description: "Spaghetti and chicken coated in a rich spinach Alfredo sauce.", price: 389, diet: "non-veg", image: "/fooditems/ps2.png", modifierGroups: sauceGroup(["Paprika Sauce", "Pesto Sauce", "White Sauce"]) },
      { id: "chicken-penne-pasta", name: "Chicken Penne Pasta", description: "Penne pasta tossed with tender chicken in a classic sauce.", price: 389, diet: "non-veg", image: "/fooditems/ps3.png", modifierGroups: sauceGroup(["Red Sauce", "Mixed Sauce"]) },
      { id: "maxibrew-special-handmade-gnocchi-pasta", name: "Maxibrew Special Handmade Gnocchi Pasta", description: "Soft handmade gnocchi tossed in our house special signature sauce.", price: 319, diet: "veg", image: "/fooditems/ps4.png", modifierGroups: sauceGroup(["Mixed Sauce", "Red Sauce", "Pesto Sauce"]) },
      { id: "spaghetti-mushroom-aglio-olio-chicken", name: "Spaghetti Mushroom Aglio Olio Chicken", description: "Spaghetti tossed with chicken, mushroom, garlic and olive oil.", price: 399, diet: "non-veg", image: "/fooditems/ps5.png", modifierGroups: sauceGroup(["Paprika Sauce", "Pesto Sauce", "White Sauce"]) },
      { id: "veg-penne-in-spinach-alfredo-pasta", name: "Veg Penne in Spinach Alfredo Pasta", description: "Penne pasta tossed in a creamy spinach Alfredo sauce.", price: 349, diet: "veg", image: "/fooditems/ps6.png", modifierGroups: sauceGroup(["Red Sauce", "Mixed Sauce"]) },
      { id: "veg-spaghetti-in-spinach-alfredo-pasta", name: "Veg Spaghetti in Spinach Alfredo Pasta", description: "Spaghetti coated in a rich, creamy spinach Alfredo sauce.", price: 349, diet: "veg", image: "/fooditems/ps7.png", modifierGroups: sauceGroup(["Paprika Sauce", "Pesto Sauce", "White Sauce"]) },
      { id: "veg-penne-pasta", name: "Veg Penne Pasta", description: "Classic penne pasta tossed in a flavourful house sauce.", price: 329, diet: "veg", image: "/fooditems/ps8.png", modifierGroups: sauceGroup(["Red Sauce", "Mixed Sauce"]) },
    ],
  },
  {
    id: "salads",
  ...
  rawMenu.forEach((category, categoryIdx) => {
    category.items.forEach((item, idx) => {
      docs.push({
        ...
        isAvailable: true,
        sortOrder: idx,
        // Menu Item Customization (Modifiers): only present on the items
        // that declare it above (via sauceGroup(...)) — every other item
        // gets undefined here, which Mongoose stores as the schema
...
// Derives one Category doc per top-level entry in rawMenu, in the same
// order buildMenuItemDocs() uses for categorySortOrder — so the category
// chips shown in the admin "Create Order" picker always match the menu
// items underneath them without needing to be entered separately.
function buildCategoryDocs() {
  return rawMenu.map((category, categoryIdx) => ({
    restaurantId: RESTAURANT_ID,
    categoryId: category.id,
...
module.exports = { RESTAURANT_ID, buildMenuItemDocs, buildCategoryDocs };